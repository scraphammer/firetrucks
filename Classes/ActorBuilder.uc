...
#exec MESH IMPORT MESH=CubeTest123 ANIVFILE=Models\untitled_a.3d DATAFILE=Models\untitled_d.3d X=0 Y=0 Z=0 LODSTYLE=10 LODFRAME=0 
#exec MESH ORIGIN MESH=CubeTest123 X=0 Y=0 Z=0 YAW=-64 PITCH=0 ROLL=0

#exec MESH SEQUENCE MESH=CubeTest123 SEQ=ALL    STARTFRAME=0 NUMFRAMES=930 RATE=15
#exec MESH SEQUENCE MESH=CubeTest123 SEQ=Still    STARTFRAME=0 NUMFRAMES=1 RATE=15
#exec MESH SEQUENCE MESH=CubeTest123 SEQ=Action    STARTFRAME=0 NUMFRAMES=120 RATE=15
#exec MESH SEQUENCE MESH=CubeTest123 SEQ=Action.001    STARTFRAME=120 NUMFRAMES=250 RATE=15
#exec MESH SEQUENCE MESH=CubeTest123 SEQ=Action.002    STARTFRAME=370 NUMFRAMES=250 RATE=15
#exec MESH SEQUENCE MESH=CubeTest123 SEQ=Action.003    STARTFRAME=620 NUMFRAMES=250 RATE=15
#exec MESH SEQUENCE MESH=CubeTest123 SEQ=CubeAction.002    STARTFRAME=870 NUMFRAMES=60 RATE=15

#exec MESHMAP NEW MESHMAP=CubeTest123 MESH=CubeTest123
#exec MESHMAP SCALE MESHMAP=CubeTest123 X=8 Y=8 Z=16
